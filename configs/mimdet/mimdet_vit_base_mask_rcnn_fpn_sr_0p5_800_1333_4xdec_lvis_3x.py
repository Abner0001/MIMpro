...
from ..lvis_v1 import dataloader
from ..common import (
...
num_gpu = 8
gpu_batchsize = 1
batch_size = num_gpu * gpu_batchsize
dataloader.train.total_batch_size = batch_size
optimizer.params.base_lr *= batch_size / 16
optimizer.lr *= batch_size / 16
train.checkpointer.period = int(160000 / batch_size)
train.eval_period = int(160000 / batch_size)
train.max_iter = int(160000 / batch_size * 36)
lr_multiplier.scheduler.milestones = [int(160000 / batch_size * 27), int(160000 / batch_size * 33)]
lr_multiplier.scheduler.num_updates = int(160000 / batch_size * 36)
...
train.output_dir = "output_n32_newmapper_wd_0.001_lr_2e-4/mimdet_vit_base_mask_rcnn_fpn_sr_0p5_800_1333_4xdec_lvis_3x"
