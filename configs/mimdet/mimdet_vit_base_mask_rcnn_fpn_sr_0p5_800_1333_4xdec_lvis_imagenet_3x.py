...
from ..lvis_imagenet import dataloader
from ..common import (
...
train.checkpointer.period = int(120000 / batch_size)
train.eval_period = int(120000 / batch_size)
train.max_iter = int(120000 / batch_size * 36)
lr_multiplier.scheduler.milestones = [int(120000 / batch_size * 27), int(120000 / batch_size * 33)]
lr_multiplier.scheduler.num_updates = int(120000 / batch_size * 36)
